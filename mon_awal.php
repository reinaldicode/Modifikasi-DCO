...
if ($proc=='-'){$sql="select * from docu where device='$dev' and doc_type='Monitor Sample' and status='$status' and section='Production' and category='$cat'  order by $by ";}
else {
...
<h1> Monitor Sample's List For Device: <strong><?php echo $device;?></strong> , Process: <strong><?php echo $proc; ?></strong>, Category: <strong><?php echo $cat; ?></strong></h1>
