...
<h1> Work Instruction's List For Device: <strong><?php echo $device;?></strong> , Process: <strong><?php echo $proc; ?></strong>, Category: <strong><?php echo $cat; ?></strong></h1>
<thead bgcolor="#00FFFF">
<tr>
	<td>No</td>
	<td>Date</td>
	<td><a href='wi_prod.php?device=<?php echo $dev; ?>&by=No_doc&status=<?php echo $status; ?>&proc=<?php echo $proc;?>&cat=<?php echo $cat; ?>&submit=Show'>No. Document</a></td>
	<td>No Rev.</td>
	<td><a href='wi_prod.php?device=<?php echo $dev; ?>&by=no_drf&status=<?php echo $status; ?>&proc=<?php echo $proc;?>&cat=<?php echo $cat; ?>&submit=Show'>drf</a></td>
	<td><a href='wi_prod.php?device=<?php echo $dev; ?>&by=title&status=<?php echo $status; ?>&proc=<?php echo $proc;?>&cat=<?php echo $cat; ?>&submit=Show'>Title</a></td>
	<td>Process</td>
	<td>Section</td>
	<td>Action</td>
...
<tr>
	...
	<?php if ($info['status']=='Secured' and $info['category']<>'External') {?>
	...
	<?php } ?>
	<?php if ($info['category']=='External') { ?>
	
	<a data-toggle="modal" data-target="#myModal2" data-id="<?php echo $info['no_drf']?>" data-nodoc="<?php echo $info['no_doc'] ?>" data-rev="<?php echo $info['rev_to'] ?>" data-lama="<?php echo $info['file']?>" data-type="<?php echo $info['category']?>" data-tipe="<?php echo $info['doc_type']?>" data-status="<?php echo $info['status']?>" class="btn btn-xs btn-success sec-file" title="Secure Document">
	<span class="glyphicon glyphicon-play" ></span></a>
	<?php }} ?>
	</td>
