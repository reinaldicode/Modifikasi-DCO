...
// 			 , email pic_email
// 			 , name pic_name 
// 			 , DATEDIFF(day, GETDATE(), fil.end_date) remaining_days
			 
// 		  from tb_m_contract con, tb_m_contract_file fil, Users u , tb_m_notif notif
// 		 where DATEDIFF(day, GETDATE(), fil.end_date) < notif.contract_notif 
// 		 and fil.id_contract=con.id_contract
// 		 and (IDUser ='003429' or IDUser ='003366')
// 		 and u.Roles <> 3 
...
if ($proc=='-'){$sql="select * from docu where device='$dev' and doc_type='MSDS' and status='$status' and category='$cat'   order by $by ";}
else {
...
<h1> MSDS's List For Device: <strong><?php echo $device;?></strong> , Process: <strong><?php echo $proc; ?></strong>, Category: <strong><?php echo $cat; ?></h1>
