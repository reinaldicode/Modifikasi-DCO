...
<?php if ($name=='Vitria') {?>
  ...
  <style> 
body {
    /*background-image: url("images/tounge.png");*/
    background-image: url("images/white.jpeg");
    background-color: #cccccc;
    /*background-repeat: no-repeat;*/
    /*background-attachment: fixed;*/
...
// echo $rows;
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <span class="navbar-brand" href="index.php"><h3><img src="images/doc-21.png" style="margin-top:-25px;" size="40px" alt=""></img></h3></span>
      ...
      <ul class="nav navbar-nav">
        ...
        <?php if ($rows<>0 and ($state=='Approver' or $state=='Admin' or $state=='Originator')){?>
          <li><a href="my_doc.php" ><img src="images/notif.gif"><br />Review <span class="badge" style="background: #00f; color: #fff;"><?php echo $rows; ?></span></a></li>
          <?php } else {?>
          <li><a href="my_doc.php" ><img src="images/text.png"><br />Review</a></li>
          <?php } ?>
        <li><a <?php if ($state=='Approver' && $nrp<>'000043'){$href='#';}else {$href='upload.php';} ?> href="<?php echo $href;?>" class="bg-info mute" ><img src="images/up.png" ><br />Upload</a></li>
    ...
    <li><a href="MSROHS.php" class="bg-info" ><img src="images/doc3.png"><br />MS & ROHS</a></li>
    <li><a href="monitor_login.php" ><img src="images/report.png"><br />Sample</a></li>
    <li><a href="msds_login.php" class="bg-info"><img src="images/doc3.png"><br />MSDS</a></li>
		<li><a href="manual.php" ><img src="images/manual.png"><br />Manual</a></li>
		<li><a href="obs_login.php" class="bg-info"><img src="images/reject.png"><br />Obsolate</a></li>
		<li><a href="search.php" ><img src="images/search3.png"><br />Search</a></li>
		<li><a href="grafik.php" class="bg-info"><img src="images/graph.png"><br />Grafik</a></li>
		<li><a href="" data-toggle="modal" data-target="#myModal3" data-usercp="<?php echo $nrp2;?>" data-passcp="<?php echo $pass2;?>" ><img src="images/logoff.png"><br />Change</a></li>

		
<?php 
// echo $pass; echo $nrp ?>
		<?php if ($state=="Admin"){?>
		<li><a href="config_head.php" ><img src="images/config.png" class="bg-info"><br />Config</a></li>
       ...
       <li class=""><a href="document/manual_approver.pdf"  ><img src="images/help.png" class="img-responsive" alt="Responsive image"> &nbsp;Help</a></li>     
       <li class="pull-right bg-info"><a href="logout.php" onClick="return confirm('Logout?')" ><img src="images/logout.png" class="img-responsive" alt="Responsive image"> &nbsp;logout</a></li> 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="chg_pass" method="POST" action="chg_pass.php" enctype="multipart/form-data">
                   	...
                   	<div class="modal-body">
						<input type="hidden" name="user" id="user" class="form-control" value="<?php echo $nrp;?>"/>
            <input type="hidden" name="pass" id="pass" class="form-control" value="<?php echo $pass;?>"/>
